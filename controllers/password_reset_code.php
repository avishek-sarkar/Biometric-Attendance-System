...
if(isset($_POST['password_reset_btn'])) {
    ...
    // Check if email exists in student_info
    $check_email = "SELECT student_name, student_email FROM student_info WHERE student_email=? LIMIT 1";
    ...
    if($result->num_rows > 0) {
        ...
        try {
            ...
            $mail->addAddress($email, $user['student_name']);
            ...
            $mail->Body = "
                ...
                <a href='http://localhost:81/Biometric-Attendance-System/views/password-change.php?token=$token&email=$email' 
...
if(isset($_POST['password_update_btn'])) {
    ...
    if($new_password === $confirm_password) {
        ...
        $update_password = "UPDATE student_info SET password=? WHERE student_email=?";
