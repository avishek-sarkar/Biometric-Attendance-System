...
<head>
    ...
    <title>Resend Verification Email - Teacher</title>
                ...
                <div class="col-md-6">
                    <div class="card shadow">
                        <div class="card-header bg-primary text-white">
                            <h4 class="mb-0">Resend Verification Email - Teacher</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <form id="resendForm" action="../controllers/teacher_resend_email.php" method="POST">
    ...
    <script>
        document.getElementById('resendForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                const response = await fetch('../controllers/teacher_resend_email.php', {
                    method: 'POST',
                    body: formData
                });
